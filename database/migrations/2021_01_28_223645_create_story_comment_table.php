...
class CreateStoryCommentTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('story_comment', function (Blueprint $table) {
            ...
            $table->integer('parent_id')->unsigned()->nullable(); // the tree-view structure reference
            ...
            $table->integer('lft')->unsigned()->nullable(); // the tree-view structure reference
            $table->integer('rgt')->unsigned()->nullable(); // the tree-view structure reference
            $table->integer('depth')->unsigned()->nullable(); // the tree-view structure reference
            $table->timestamps();
        });
    }
